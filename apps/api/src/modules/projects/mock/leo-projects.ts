...
export const leoProjects: CreateProjectRequestDto[] = [
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/50-2a3b57f4596b80349dabdf40760ed604?source=copy_link',
    planId: '633',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'WEB', to: 4 },
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/MY4CUT-2a3b57f4596b80cfbb65d5343430f563?source=copy_link',
    planId: '565',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'ANDROID', to: 3 },
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/BarKit-2a2b57f4596b808585d6f2a7dcf1e23f?source=copy_link',
    planId: '251',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'WEB', to: 4 },
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/Co-N-next-2a3b57f4596b800597f0e7f0a7f43797?source=copy_link',
    planId: '233',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'WEB', to: 4 },
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/Finders-2a3b57f4596b8079bdfdc041557b9a68?pvs=25',
    planId: '634',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'WEB', to: 4 },
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/Proovy-2a3b57f4596b809fbfe1edd30c33c621?pvs=25',
    planId: '635',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'WEB', to: 4 },
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/Verbly-2a4b57f4596b800d93bfd11df92bc88a?pvs=25',
    planId: '554',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'WEB', to: 5 },
  ...
  },
  {
    ...
    link: 'https://makeus-challenge.notion.site/ALLPLAY-2a3b57f4596b80a6a449d8ded32063a5?pvs=25',
    planId: '140',
    partTo: [
      { part: 'DESIGN', to: 1 },
      { part: 'WEB', to: 4 },
